                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          'Design a mordern and unique logo\nwith copyright.',
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 15.0, 0.0, 0.0),
                                          child: Text(
                                            'Hi!\n\nI Will design a modern, unique logo Professional logo.\n\nLaunch our logo maker tool and start by entering your company name, then choose logo styles, colors, and icons. Bring our online logo creator free to use in action to design an easy-to-recall brand mark for your business. Choose from hundreds of professional logo templates from our logo creator\'s free library that are sure to amaze you.',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily:
