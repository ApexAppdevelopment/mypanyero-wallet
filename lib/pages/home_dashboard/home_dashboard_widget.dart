                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      AuthUserStreamWidget(
                                                        builder: (context) =>
                                                            Text(
                                                          '₱ ${valueOrDefault(currentUserDocument?.waletbalance, 0).toString()}'
                                                              .maybeHandleOverflow(
                                                            maxChars: 7,
                                                          ),
                            ...
                            child: StreamBuilder<List<TransactionsRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<TransactionsRecord>
                                    listViewTransactionsTransactionsRecordList =
                                    snapshot.data!;
                                if (listViewTransactionsTransactionsRecordList
                                    .isEmpty) {
                                  return Center(
                                    child: SizedBox(
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount:
                                      listViewTransactionsTransactionsRecordList
                                          .length,
                                  itemBuilder:
                                      (context, listViewTransactionsIndex) {
                                    final listViewTransactionsTransactionsRecord =
                                        listViewTransactionsTransactionsRecordList[
                                            listViewTransactionsIndex];
                                    return Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 0.0),
                                      child: Column(
                                                      ...
                                                      Expanded(
                                                        child: Padding(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                listViewTransactionsTransactionsRecord
                                                                    .name,
