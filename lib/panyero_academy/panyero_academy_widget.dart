...
class PanyeroAcademyWidget extends StatefulWidget {
  const PanyeroAcademyWidget({super.key});

  @override
  State<PanyeroAcademyWidget> createState() => _PanyeroAcademyWidgetState();
}

class _PanyeroAcademyWidgetState extends State<PanyeroAcademyWidget> {
  late PanyeroAcademyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PanyeroAcademyModel());
