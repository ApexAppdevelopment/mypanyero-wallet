...
import 'panyero_careers_model.dart';
export 'panyero_careers_model.dart';

class PanyeroCareersWidget extends StatefulWidget {
  const PanyeroCareersWidget({super.key});

  @override
  State<PanyeroCareersWidget> createState() => _PanyeroCareersWidgetState();
}

class _PanyeroCareersWidgetState extends State<PanyeroCareersWidget> {
  late PanyeroCareersModel _model;
