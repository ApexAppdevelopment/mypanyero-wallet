...
import 'banners_list_model.dart';
export 'banners_list_model.dart';
...
class _BannersListWidgetState extends State<BannersListWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BannersListModel());
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Avail Discounted Promotions with Cashback!',
